...
!hj change ix to im
     ...
     real(kind=kind_phys), dimension (im,km) :: up_entr_d, up_detr_d, dd_entr_d,dd_detr_d
     real(kind=kind_phys), dimension (im,km) :: up_entr_m, up_detr_m, dd_entr_m,dd_detr_m
     real(kind=kind_phys), dimension (im,km) :: up_entr_s, up_detr_s
!+lxz
